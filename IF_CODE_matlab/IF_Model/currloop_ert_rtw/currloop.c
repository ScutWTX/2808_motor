 ...
 * C/C++ source code generated on : Thu Aug 29 10:06:39 2024
 *
...
void currloop_step(void)
{
   ...
   */
  rtb_SignPreSat = rtb_Sum1 * 0.000125F + (real32_T)rtDW.Integrator_DSTATE_p *
    0.0001F;
   ...
   */
  rtb_Integrator = rtb_IProdOut * 0.000125F + rtDW.Integrator_DSTATE;
   ...
   */
  rtb_IProdOut_d = (int16_T)floorf(rtb_Sum1 * 1.75F);
